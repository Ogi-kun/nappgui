...
String *str_cn(const char_t *str, uint32_t n);

String *str_trim(const char_t *str);

String *str_trim_n(const char_t *str, uint32_t n);
...
String *str_reserve(uint32_t n);

String *str_fill(uint32_t n, const char_t c);
...
void str_copy_c(char_t *dest, uint32_t size, const char_t *src);

void str_copy_cn(char_t *dest, uint32_t size, const char_t *src, uint32_t n);

void str_cat(String **dest, const char_t *src);

void str_cat_c(char_t *dest, uint32_t size, const char_t *src);
...
int str_cmp_cn(const char_t *str1, const char_t *str2, uint32_t n);
...
bool_t str_equ_cn(const char_t *str1, const char_t *str2, uint32_t n);
...
void str_upper_c(char_t *dest, uint32_t size, const char_t *str);

void str_lower_c(char_t *dest, uint32_t size, const char_t *str);

void str_subs(String *str, const char_t replace, const char_t with_);

void str_repl_c(char_t *str, const char_t *replace, const char_t *with_);
...
int8_t str_to_i8(const char_t *str, uint32_t base, bool_t *error);

int16_t str_to_i16(const char_t *str, uint32_t base, bool_t *error);

int32_t str_to_i32(const char_t *str, uint32_t base, bool_t *error);

int64_t str_to_i64(const char_t *str, uint32_t base, bool_t *error);

uint8_t str_to_u8(const char_t *str, uint32_t base, bool_t *error);

uint16_t str_to_u16(const char_t *str, uint32_t base, bool_t *error);

uint32_t str_to_u32(const char_t *str, uint32_t base, bool_t *error);

uint64_t str_to_u64(const char_t *str, uint32_t base, bool_t *error);
